package com.shf.pinda.user.config;

import java.util.List;
import com.shf.pinda.user.feign.UserResolveApi;
import com.shf.pinda.user.interceptor.ContextHandlerInterceptor;
import com.shf.pinda.user.resolver.ContextArgumentResolver;
