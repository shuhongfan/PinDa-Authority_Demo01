package com.shf.pinda.log.aspect;
...
import com.shf.pinda.log.event.SysLogEvent;
import com.shf.pinda.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.shf.pinda.log.annotation.SysLog)")
